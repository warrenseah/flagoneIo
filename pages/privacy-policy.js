      ...
      <div className="text-container ptb-100">
        <div className="container">
          ...
          <p>
            ...
            &#8220;our&#8221;) operates the FlagOne.io website (the
            &#8220;Service&#8221;).
          </p>
          ...
          <ul>
            <li>
              Flag One Pte Ltd uses the collected data for various purposes:
            </li>
          ...
          <p>
            ...
            Personal Data, to Singapore and process it there.
          </p>
          <p>
          ...
          <p>
            Flag One Pte Ltd will take all steps reasonably necessary to ensure
          ...
          <p>
            Flag One Pte Ltd may disclose your Personal Data in the good faith
            belief that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>
              To protect and defend the rights or property of Flag One Pte Ltd
            </li>
            <li>
